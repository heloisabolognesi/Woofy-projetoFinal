            ...
            >
              ...
              <div className="relative aspect-square overflow-hidden bg-gray-100 dark:bg-slate-700">
                ...
                <div className="absolute inset-0 flex items-center justify-center gap-4 opacity-0 group-hover:opacity-100 transition-all duration-500">
                  <a
                    href="#"
                    className="p-3 bg-white/90 text-[#305165] hover:bg-[#AAC9BA] hover:text-white rounded-full transition-all duration-300 hover:scale-110 shadow-lg translate-y-4 group-hover:translate-y-0"
                    aria-label="LinkedIn"
                  >
                  ...
                  <a
                    href="#"
                    className="p-3 bg-white/90 text-[#305165] hover:bg-[#AAC9BA] hover:text-white rounded-full transition-all duration-300 hover:scale-110 shadow-lg translate-y-4 group-hover:translate-y-0 delay-75"
