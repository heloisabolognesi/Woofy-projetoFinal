...
const carouselImages = [
  ...
  {
    url: "https://images.unsplash.com/photo-1447684808650-354ae64db5b8?q=80&w=1920",
    alt: "Filhote de Labrador chocolate olhando para cima",
  },
  {
    url: "https://images.unsplash.com/photo-1543466835-00a7907e9de1?q=80&w=1920",
    alt: "Beagle sorridente com língua para fora",
  },
  {
    url: "https://images.unsplash.com/photo-1518717758536-85ae29035b6d?q=80&w=1920",
    alt: "Labrador chocolate adulto lambendo o focinho",
  },
  {
    url: "https://images.unsplash.com/photo-1491604612772-6853927639ef?q=80&w=1920",
    alt: "Husky Siberiano preto e branco em close-up",
  },
  {
    url: "https://images.unsplash.com/photo-1618161456243-aa4dd6b14e8c?q=80&w=1920",
    alt: "Border Collie preto e branco em retrato",
  },
  {
    url: "https://images.unsplash.com/photo-1570089991126-4bf0440e0fe5?q=80&w=1920",
    alt: "Gato laranja tabby em retrato",
  },
  {
    url: "https://images.unsplash.com/photo-1562119464-7480f81577cc?q=80&w=1920",
    alt: "Gato Persa branco em pose elegante",
  },
  {
    url: "https://images.unsplash.com/photo-1665925480229-3be33d64c8ff?q=80&w=1920",
    alt: "Gatinho deitado em cobertor macio",
  },
  {
    url: "https://images.unsplash.com/photo-1663043501785-05d17c625253?q=80&w=1920",
    alt: "Casal de coelhos fofos em gaiola",
  },
]
...
export function HeroSection() {
  ...
  return (
    <section className="relative min-h-[100svh] lg:min-h-[820px] flex flex-col overflow-hidden pt-24 pb-10 sm:pb-12 lg:pb-14">
      ...
      {/* Spacer */}
      <div className="hidden lg:block h-6 z-20" />

      {/* ===== Centered Hero Content ===== */}
      <div className="max-w-5xl mx-auto px-4 sm:px-6 w-full text-center flex flex-col items-center justify-center gap-4 sm:gap-5 text-white z-20 flex-1 py-6 sm:py-8 lg:py-10">
        {/* — Brand Logo — */}
        <div className="mb-4 animate-in fade-in zoom-in-75 duration-1000 ease-out">
          <img
            src="/logo-pet-shop.png"
            alt="Woofy Logo"
            className="h-24 sm:h-32 lg:h-40 xl:h-44 max-w-[82vw] w-auto object-contain drop-shadow-[0_4px_18px_rgba(0,0,0,0.35)]"
          />
        </div>

        {/* — Clinic Name — */}
        <h1 className="text-3xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight leading-[1.1] font-serif text-white drop-shadow-lg animate-in fade-in slide-in-from-bottom-4 duration-700 delay-200">
          Clínica Veterinária{" "}
        ...
        {/* — Slogan — */}
        <p className="text-sm sm:text-lg lg:text-xl text-gray-200/90 max-w-2xl leading-relaxed animate-in fade-in slide-in-from-bottom-4 duration-700 delay-300">
        ...
        {/* — CTA Buttons — */}
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-center gap-3 sm:gap-4 mt-2 sm:mt-3 w-full sm:w-auto animate-in fade-in slide-in-from-bottom-4 duration-700 delay-500">
          <Button
            size="lg"
            asChild
          ...
          <Button
            size="lg"
            asChild
            className="border-2 border-white bg-white/95 !text-[#305165] hover:bg-[#F5F4EE] hover:!text-[#305165] font-bold rounded-full px-6 sm:px-8 h-12 sm:h-14 text-sm sm:text-base shadow-xl shadow-black/15 backdrop-blur-sm transition-all duration-300 hover:scale-105"
          >
      ...
      {/* Bottom section: Indicators & hero cards */}
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 z-20 flex flex-col gap-4 sm:gap-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 lg:gap-6">
          {/* Card 1 */}
          <div className="bg-white/95 dark:bg-slate-900/95 backdrop-blur-xl rounded-2xl p-5 lg:p-6 shadow-xl border border-gray-100/50 dark:border-slate-800/80 transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl group">
